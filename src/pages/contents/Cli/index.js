...
export default function Cli() {
    ...
    return (
        <Content idConteudo='5f6f518d473b7899c7bcac10'>
            <section>
            ...
            <section>
                ...
                <p>
                    ...
                    CLI para abrir o VS dentro do diretório atual que está sendo executado <span role="img" aria-label="Piscada">😉</span>)
                </p>
            ...
            <section>
                ...
                <p>
                    Com isso chegamos ao fim da criação da nossa CLI. <span role="img" aria-label="Palmas">👏👏👏</span>
                </p>
            </section> 
            <section>
